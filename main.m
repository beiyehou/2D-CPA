...
xlabel('时刻','fontsize',Font_size,'fontname',Font_name);
ylabel('权值','fontsize',Font_size,'fontname',Font_name);
...
legend('横向预测输出' , '纵向预测输出' ,'实际网路流量', '二维协作预测输出','Location','NorthWest');

xlabel('时刻','fontsize',Font_size,'fontname',Font_name);
ylabel('流量值(bps)','fontsize',Font_size,'fontname',Font_name);
...
title('横向预测误差分布','fontsize',Font_size,'fontname',Font_name);
set(gca,'fontsize',Font_size,'fontname',Font_name);
subplot(3,1,2);
hist(line_data' - output_test,[axis_min:axis_step:axis_max]);
title('纵向预测误差分布','fontsize',Font_size,'fontname',Font_name);
set(gca,'fontsize',Font_size,'fontname',Font_name);
subplot(3,1,3);
hist(prediction_value_a' - output_test,[axis_min:axis_step:axis_max]);
title('二维协作预测误差分布','fontsize',Font_size,'fontname',Font_name);
set(gca,'fontsize',Font_size,'fontname',Font_name);
% 平滑 a 误差分析 MSE 和 方差
figure_4 = figure(4);
...
legend(bar_hander,'横向预测','纵向预测','二维协作预测');

set(gca,'xticklabel' , {'均方误差' ,'方差'},'fontsize' ,Font_size,'fontname',Font_name);
